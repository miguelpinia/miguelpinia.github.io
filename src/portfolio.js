...
const greeting = {
  title: 'Hello! 👋',
  title2: 'Diddy_',
  logo_name: 'Miguel Piña',
  nickname: 'miguelpinia / diddy_',
...
const socialMediaLinks = {
  ...
  github: 'https://github.com/miguelpinia',
  linkedin: 'https://www.linkedin.com/in/miguelpinia/',
  gmail: 'miguelpinia1@gmail.com',
  gitlab: 'https://gitlab.com/miguelpinia',
  facebook: 'https://www.facebook.com/#/',
  twitter: 'https://twitter.com/miguelpinia',
  instagram: 'https://www.instagram.com/miguelpinia/',
};
  ...
  data: [
    {
      ...
      skills: [
        "🚀 I'm in the Computer Science and Engineering Doctorate Degree Program @ UNAM, México",
        '🚀 Assistant professor in Faculty of Sciences @ UNAM, México.',
        '🚀 Research in the area of concurrent and distributed computing',
        '🚀 Also interested in Software Engineering, Databases and Functional Programming',
    ...
    },
    {
      ...
      skills: [
        ...
        '⚡ Creating application backend in Node/Express, Java/Spring, Python/Django',
        '⚡ Integration of third party services such as AWS',
        '⚡ Design and Implementation of Relational and Non-Relational Databases',
      ],
      softwareSkills: [
        {
          skillName: 'Java',
    ...
    },
    {
      ...
      skills: [
        "🚀 I'm interested in Data Science, so currently I'm studying more about statistics, probability and other topics related to data science",
        '🚀 Interested in a theoretical and practical manner',
      ],
      softwareSkills: [],
    },
  ],
...
const contactPageData = {
  ...
  blogSection: {
    ...
    link: 'https://twitter.com/miguelpinia',
